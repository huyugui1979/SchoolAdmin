        ...
        $scope.gridOptions = {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    cellTemplate:'<select ng-model="row.entity.BeginSubjectDate" style="background-color:white;width: 100%;border-radius: 0;height: 100%;border: 0;"><option value="0">请选择</option><option value="8:10">第一节</option><option value="10:10">第三节</option><option value="14:30">第五节</option><option value="19:00">第八节</option><option value="18:30">晚上4节开始上课</option></select>'

                },
                {
                    name:'下课时间',
                    field: 'EndSubjectDate',
                    cellTemplate:'<select ng-model="row.entity.EndSubjectDate" style="background-color:white;width: 100%;border-radius: 0;height: 100%;border: 0;"><option value="0">请选择</option><option value="9:50">第二节</option><option value="10:55">第三节</option><option value="11:50">第四节</option><option value="16:10">第六节</option><option value="17:05">第七节</option><option value="20:40">第九节</option><option value="21:40">第十节</option><option value="22:40">晚上4节下课</option></select>'
